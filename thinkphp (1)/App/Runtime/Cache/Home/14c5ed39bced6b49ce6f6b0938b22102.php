...
<div class="headerBar">
	<div class="topBar">
		<div class="comWidth">
			...
			<div class="rightArea">
				欢迎来到二手交易书城！<a href="login.html">[登录]</a><a href="register.html">[免费注册]</a>
			</div>
		</div>
	</div>
	<div class="logoBar">
...
<div class="userPosition comWidth">
	...
	<span>&nbsp;&gt;&nbsp;</span>
	<a href="#"><?php echo ($u["cname"]); ?></a>
	<span>&nbsp;&gt;&nbsp;</span>
	<em><?php echo ($s["psn"]); ?></em>
</div>
	...
	<div class="description clearfix">
		...
		<div class="rightArea">
			<div class="des_content">
				<h3 class="des_content_tit"><?php echo ($s["pname"]); ?></h3>
				<div class="dl clearfix">
					<div class="dt">商品价</div>
					<div class="dd clearfix"><span class="des_money"><em>￥</em><?php echo ($s["mprice"]); ?></span></div>
				</div>
				<div class="dl clearfix">
					<div class="dt">会员价</div>
					<div class="dd clearfix"><span class="des_money"><em>￥</em><?php echo ($s["vprice"]); ?></span></div>
				</div>
			...
			<div class="review_listBox">
				<div class="review_list clearfix">
					...
					<div class="review_cont">
						...
						<p>承认是第一次读她，原来以为她只会说话只会主持活动，不料她竟然也很能讲故事。。。</p>
