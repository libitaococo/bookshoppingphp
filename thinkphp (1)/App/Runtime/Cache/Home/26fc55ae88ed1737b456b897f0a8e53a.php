...
<iframe src="top_nologin.htm" frameborder="0" marginheight="0" marginwidth="0" width="770" height="130" scrolling="no"></iframe>
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="yrh" align="center">
  <tr>
    <td height="17"><a href="index.htm">主页</a> &raquo; 新用户注册</td>
  </tr>
</table>
<table width="770" border="0" cellpadding="0" cellspacing="0" class="main" align="center">
<tr valign="top">
<td><form action="<?php echo U('/Home/Login/register');?>" method="post" enctype="multipart/form-data" name="form1">
...
&nbsp;
&nbsp;
<input type="Button" class="bt2" name="button3" value="返回" onClick="javascript:window.location.href='index.htm'">
            </td>
